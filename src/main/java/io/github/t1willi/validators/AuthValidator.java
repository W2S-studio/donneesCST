...
public class AuthValidator implements IAuthValidator {
    ...
    public boolean validateRegistration(Form form) {
        form.field("username")
                ...
                .regex("^[a-zA-Z0-9]+$", "Votre nom d'utilisateur ne peut contenir que des lettres et des chiffres.");
    ...
    public boolean validateEmailUpdate(Form form) {
        form.field("email")
                .required("Le nouveau mail est obligatoire.")
                .email("Le nouveau mail n'est pas valide.");
